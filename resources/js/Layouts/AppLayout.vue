                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('configuracion')" :active="route().current('configuracion')">
                                    Configuracion
                                </jet-nav-link>
                                <jet-nav-link :href="route('cabin.index')" :active="route().current('cabin.index')">
                                    Cabañas
                                </jet-nav-link>
                            </div>
                        </div>
    ...
    export default {
        ...
        updated: function(){
            if(this.$page.props.flash.message != null){
                this.$toast.add(this.$page.props.flash.message);
